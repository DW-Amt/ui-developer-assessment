    ...
    NewComponent.prototype.connectingButton = function () {
        ...
        for (var i = 0; i < buttons.length; i++) {
            buttons[i].addEventListener('click', function (event) {
                ...
                document.getElementById("response").firstChild.textContent = target.textContent;
            }, false);
        }
    };
    ...
    NewComponent.prototype.render = function () {
        ...
        if (!this.state) {
            return React.createElement("button", { onClick: function onClick() {
                    _this.connectingButton();_this.setState({ connect: true });
                } }, "connect");
        }
        return React.createElement("div", null, React.createElement("button", { onClick: this.connectinginfo }, "reset"), React.createElement("p", { id: 'response' }, "hello"));
    };
    return NewComponent;
}(React.Component);
